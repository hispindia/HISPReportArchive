...
try {
    var job = new CronJob('00 12 * * *', function() {
            ...
            page.property('onNavigationRequested', function (url, type, willNavigate, main) {
                console.log( 'Current Date -- ' + new Date() + ' -- ' +'= onNavigationRequested');
            ...
            page.property('onLoadFinished', function() {
                console.log( 'Current Date -- ' + new Date() + ' -- ' + '==== onLoadFinished()');
                try{
                   //this.page.render('googleScreenShot' + '.png');
	...
	//const BASE_URL = "http://127.0.0.1:8090/tibet";
